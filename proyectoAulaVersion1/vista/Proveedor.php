            ...
            switch($button){
                ...
                case "actualizar": 
                  ...
                  $statusConfInactivar="display:block";
                    ...
                    $objProveedor= new Proveedor($codigo,$nombre,$tipo,$fRegistro,$fInac,$urlFoto,$email,$telefono,0);
                    $objControlProveedor= new ControlProveedor($objProveedor);
            ...
            <a class=\"dropdown-item\" href=\"Usuario.php\">Usuario</a>
                ...
                <form class=\"form-inline my-2 my-lg-0\">
                  ...
                  <img src=\"$urlFoto\" height=\"80\" width=\"100\" style =\"$statusImgFoto\">
                    ...
                    <input type=\"text\" class=\"form-control\"value=\"$TIPO\"  id=\"tipo\" name=\"txtTipo\" placeholder=\"1:Natural/2:Juridica\">
                    </div>
